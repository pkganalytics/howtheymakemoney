...
import VrtvSidePanel from '../components/vrtv/vrtvSidePanel';
...
const Sankey = () =>  {
	const _quarter = useSelector(state => state.vrtvquarter);
...
<Layout title="Sankey Diagrams">
  ...
  <Grid item>
		<Typography variant="h3"> Veritiv Corporation (VRTV) </Typography>
