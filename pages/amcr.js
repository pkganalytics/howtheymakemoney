...
import AmcrSidePanel from '../components/amcr/amcrSidePanel';
...
const Sankey = () =>  {
	const _quarter = useSelector(state => state.amcrquarter);
...
<Layout title="Sankey Diagrams">
  ...
  <Grid item>
		<Typography variant="h3"> Amcor PLC (AMCR) </Typography>
