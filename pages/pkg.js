...
import PkgSidePanel from '../components/pkg/pkgSidePanel';
...
const Sankey = () =>  {
	const _quarter = useSelector(state => state.pkgquarter);
...
<Layout title="Sankey Diagrams">
  ...
  <Grid item>
		<Typography variant="h3"> Packaging Corporation of American (PKG) </Typography>
