...
import SeeSidePanel from '../components/see/seeSidePanel';
...
const Sankey = () =>  {
	const _quarter = useSelector(state => state.seequarter);
...
<Layout title="Sankey Diagrams">
  ...
  <Grid item>
		<Typography variant="h3"> Sealed Air Corporation (SEE) </Typography>
