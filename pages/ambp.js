...
import AmbpSidePanel from '../components/ambp/ambpSidePanel';
...
const Sankey = () =>  {
	const _quarter = useSelector(state => state.ambpquarter);
...
<Layout title="Sankey Diagrams">
  ...
  <Grid item>
		<Typography variant="h3"> Ardagh Group (AMBP) </Typography>
