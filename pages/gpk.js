...
import GpkSidePanel from '../components/gpk/gpkSidePanel';
...
const Sankey = () =>  {
	const _quarter = useSelector(state => state.gpkquarter);
...
<Layout title="Sankey Diagrams">
  ...
  <Grid item>
		<Typography variant="h3"> Graphics Packaging Holding Company (GPK) </Typography>
