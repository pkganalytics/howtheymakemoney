...
import IpSidePanel from '../components/ip/ipSidePanel';
...
const Sankey = () =>  {
	const _quarter = useSelector(state => state.ipquarter);
...
<Layout title="Sankey Diagrams">
  ...
  <Grid item>
		<Typography variant="h3"> The International Paper Company (IP) </Typography>
